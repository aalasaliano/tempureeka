        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#EAC4D5] p-6 rounded-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
                  <ul className="text-sm text-[#000000] list-disc ml-4 mr-4">
                    <li>Deadlines</li>
                    <li>Lack of Sleep</li>
            ...
            <div className ="bg-[#FCE8DB] p-6 rounded-2xl">
                ...
                <ul className="list-disc ml-5 text-sm text-[#000000] mb-4">
                    <li>Checked in 7 days in a row</li>
                    <li>Slept more than 6 hours 3 times</li>
                    <li>Successfully completed 3 micro-therapy sessions</li>
                    <li>Noticed feelings of anxiety and labeled them appropriately</li>
                    <li>Wrote 1 honest reflection about feeling overwhelmed</li>
                </ul>

                { /* Quotes */}
                <div>
                    <h6 className="italic font-semibold text-[#000000] text-xs text-center mb-2">“Small steps count. You’ve walked, that’s what’s important.”</h6>
                </div>
            </div>
        </div>
    </main>
